...
public enum ErrorCode {
	...
	CACHE_SERIALIZATION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "CACHE_SERIALIZATION_FAILED", "캐시 직렬화에 실패했습니다."),
	CACHE_DESERIALIZATION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "CACHE_DESERIALIZATION_FAILED", "캐시 역직렬화에 실패했습니다."),
	CACHE_RECHECK_INTERRUPTED(HttpStatus.INTERNAL_SERVER_ERROR, "CACHE_RECHECK_INTERRUPTED", "캐시 재조회 대기 중 인터럽트가 발생했습니다."),
	;
